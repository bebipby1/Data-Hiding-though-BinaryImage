...
class Root(Tk):
    ...
    def createAuthourInfos(self):
        self.lblName_tab0 = ttk.Label(self.tab0,     text="Name:  Nguyen, Truong An")
        self.lblName_tab0.grid(row=1, column=0, sticky=W)
        self.lblEmail1_tab0 = ttk.Label(self.tab0,   text="Email:   nguyentruongan.it.dlu@gmail.com")
        self.lblEmail1_tab0.grid(row=2, column=0, sticky=W)
        self.lblEmail2_tab0 = ttk.Label(self.tab0,   text="             Truong.Nguyen@Student.HTW-Berlin.de")
        self.lblEmail2_tab0.grid(row=3, column=0, sticky=W)
        self.lblFacebook_tab0 = ttk.Label(self.tab0, text="FB:        fb.com/yiianguyen")
        self.lblFacebook_tab0.grid(row=4, column=0, sticky=W)
    #====== END AUTHOR TAB ===========#
